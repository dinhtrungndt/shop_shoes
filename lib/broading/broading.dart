    ...
    return Scaffold(
      ...
      body: Container(
        decoration: const BoxDecoration(
          ...
          Color.fromARGB(255, 183, 224, 255),
          Color.fromARGB(235, 146, 239, 255),
          Color.fromARGB(255, 173, 209, 237),
        ])),
        child: Stack(
          children: [
            Positioned(
                ...
                child: Column(
                  children: [
                    CarouselSlider(
                      ...
                      options: CarouselOptions(
                        ...
                        autoPlayInterval: const Duration(
                            seconds: 2), // Thời gian chuyển hình ảnh
                    ...
                    const Padding(
                      ...
                      child:
                          Text("Smart, comfortable and elegant shoes for you",
                              style: TextStyle(
                                fontSize: 20,
                                fontFamily: 'Poppins',
                                color: Color.fromARGB(255, 28, 148, 157),
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromARGB(255, 93, 202, 209),
